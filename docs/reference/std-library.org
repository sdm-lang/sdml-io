...
:PROPERTIES:
:CUSTOM_ID: lib:constraint-language
:END:
...
The standard library provides methods to constraints in the form of type classes (see section [[#lib:type-classes]])
