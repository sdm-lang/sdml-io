...
:PROPERTIES:
:CUSTOM_ID: primer:why-domain-model
:END:
...
** Where do I start?
:PROPERTIES:
:CUSTOM_ID: primer:where-to-start
:END:
...
** What it isn't
:PROPERTIES:
:CUSTOM_ID: primer:what-sdml-is-not
:END:
...
:PROPERTIES:
:CUSTOM_ID: primer:what-can-it-do
:END:
...
** Capture Entities
:PROPERTIES:
:CUSTOM_ID: primer:capture-entities
:END:
...
:PROPERTIES:
:CUSTOM_ID: primer:add-structures-and-enums
:END:
...
** Drawing Diagrams
:PROPERTIES:
:CUSTOM_ID: primer:how-to-draw-diagrams
:END:
...
** Document Modules
:PROPERTIES:
:CUSTOM_ID: primer:how-to-document-modules
:END:
...
** For Tool Builders
:PROPERTIES:
:CUSTOM_ID: primer:for-tool-builders
:END:
...
** More Reading
:PROPERTIES:
:CUSTOM_ID: primer:more-reading
:END:

- [[https://sdml.io#intro-what-is-domain-modeling][What is Domain Modeling?]] in the SDML reference.
